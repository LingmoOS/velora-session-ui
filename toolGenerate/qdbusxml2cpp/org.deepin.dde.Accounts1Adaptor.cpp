 ...
 * Command line was: qdbusxml2cpp ./dde-session-ui/xml/org.lingmo.Accounts1.xml -a ./dde-session-ui/toolGenerate/qdbusxml2cpp/org.lingmo.Accounts1Adaptor -i ./dde-session-ui/toolGenerate/qdbusxml2cpp/org.lingmo.Accounts1.h
 *
...
#include "./dde-session-ui/toolGenerate/qdbusxml2cpp/org.lingmo.Accounts1Adaptor.h"
...
{
    // handle method call org.lingmo.Accounts1.AllowGuestAccount
    QMetaObject::invokeMethod(parent(), "AllowGuestAccount", Q_ARG(bool, in0));
}

QString Accounts1Adaptor::CreateGuestAccount()
{
    // handle method call org.lingmo.Accounts1.CreateGuestAccount
    QString out0;
...
{
    // handle method call org.lingmo.Accounts1.CreateUser
...
{
    // handle method call org.lingmo.Accounts1.DeleteUser
...
{
    // handle method call org.lingmo.Accounts1.FindUserById
    QString out0;
...
{
    // handle method call org.lingmo.Accounts1.FindUserByName
    QString out0;
...
{
    // handle method call org.lingmo.Accounts1.GetGroups
    QStringList out0;
...
{
    // handle method call org.lingmo.Accounts1.GetPresetGroups
    QStringList out0;
...
{
    // handle method call org.lingmo.Accounts1.IsPasswordValid
...
{
    // handle method call org.lingmo.Accounts1.IsUsernameValid
    //return static_cast<YourObjectType *>(parent())->IsUsernameValid(in0, out1, out2);
}

QString Accounts1Adaptor::RandUserIcon()
{
    // handle method call org.lingmo.Accounts1.RandUserIcon
    QString out0;
